...
namespace CascadedShadowMaps11
{
    unsafe struct AllShadowDataConstantBuffer
    {
        ...
        public fixed float m_fCascadeFrustumsEyeSpaceDepthsFloat4[4 * 8];// the values along Z that separte the cascades. Wastefully stored in float4 so they are array indexable :(
