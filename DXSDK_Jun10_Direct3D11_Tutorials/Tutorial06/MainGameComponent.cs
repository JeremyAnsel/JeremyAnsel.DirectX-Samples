...
namespace Tutorial06
{
    class MainGameComponent : IGameComponent
    {
        ...
        private D3D11PixelShader pixelShaderSolid;
        ...
        {
            new SimpleVertex( new XMFloat3( -1.0f, 1.0f, -1.0f ), new XMFloat3( 0.0f, 1.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( 1.0f, 1.0f, -1.0f ), new XMFloat3( 0.0f, 1.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( 1.0f, 1.0f, 1.0f ), new XMFloat3( 0.0f, 1.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( -1.0f, 1.0f, 1.0f ), new XMFloat3( 0.0f, 1.0f, 0.0f ) ),
            ...
            new SimpleVertex( new XMFloat3( -1.0f, -1.0f, 1.0f ), new XMFloat3( -1.0f, 0.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( -1.0f, -1.0f, -1.0f ), new XMFloat3( -1.0f, 0.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( -1.0f, 1.0f, -1.0f ), new XMFloat3( -1.0f, 0.0f, 0.0f ) ),
            new SimpleVertex( new XMFloat3( -1.0f, 1.0f, 1.0f ), new XMFloat3( -1.0f, 0.0f, 0.0f ) ),
            ...
            new SimpleVertex( new XMFloat3( -1.0f, -1.0f, -1.0f ), new XMFloat3( 0.0f, 0.0f, -1.0f ) ),
            new SimpleVertex( new XMFloat3( 1.0f, -1.0f, -1.0f ), new XMFloat3( 0.0f, 0.0f, -1.0f ) ),
            new SimpleVertex( new XMFloat3( 1.0f, 1.0f, -1.0f ), new XMFloat3( 0.0f, 0.0f, -1.0f ) ),
            new SimpleVertex( new XMFloat3( -1.0f, 1.0f, -1.0f ), new XMFloat3( 0.0f, 0.0f, -1.0f ) ),
        ...
        private readonly XMFloat4[] lightDirs = new XMFloat4[2]
        {
            new XMFloat4( -0.577f, 0.577f, -0.577f, 1.0f ),
            new XMFloat4( 0.0f, 0.0f, -1.0f, 1.0f ),
        };

        private readonly XMFloat4[] lightColors = new XMFloat4[2]
        {
            new XMFloat4( 0.5f, 0.5f, 0.5f, 1.0f ),
            new XMFloat4( 0.5f, 0.0f, 0.0f, 1.0f )
        };
