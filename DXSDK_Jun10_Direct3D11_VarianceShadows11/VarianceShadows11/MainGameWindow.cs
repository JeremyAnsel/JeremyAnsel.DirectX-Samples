...
namespace VarianceShadows11
{
    class MainGameWindow : GameWindowBase
    {
        ...
        public DepthBufferFormat ShadowBufferFormat
        {
            get
            {
                return this.mainGameComponent?.ShadowBufferFormat ?? DepthBufferFormat.R32G32;
            }
        ...
        public int ShadowBlurSize
        {
            get
            {
                return this.mainGameComponent?.ShadowBlurSize ?? 3;
            }
            ...
            set
            {
                ...
                this.mainGameComponent.ShadowBlurSize = value;
                this.NotifyPropertyChanged();
            }
        }
        ...
        public ShadowFilter ShadowFilter
        {
            get
            {
                return this.mainGameComponent?.ShadowFilter ?? ShadowFilter.Anisotropic16x;
            }
            ...
            set
            {
                ...
                this.mainGameComponent.ShadowFilter = value;
                this.NotifyPropertyChanged();
                this.SelectedCamera = CameraSelection.EyeCamera;
            }
        }
